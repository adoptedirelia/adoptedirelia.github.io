...
<img src="https://raw.githubusercontent.com/adoptedirelia/pictures_of_posts/main/Remember%20the%20Difference%3ACross-Domain%20Few-Shot%20Semantic%20Segmentation%20via%20Meta-Memory%20Transfer/pic1.png" width="100%"> 

$Memory = {M = (m_j \in R^{1 \times C})_{j=1}^N, E =  (e_j \in R^{1 \times C})_{j=1}^N}  $
